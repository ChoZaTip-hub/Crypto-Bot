...
class AuditEventType(StrEnum):
    ...
    POSITION_SL_TP_CLOSED = "POSITION_SL_TP_CLOSED"
    RATIO_SWAP_PROPOSED = "RATIO_SWAP_PROPOSED"
    RATIO_SWAP_EXECUTED = "RATIO_SWAP_EXECUTED"
    RATIO_SWAP_REJECTED = "RATIO_SWAP_REJECTED"
